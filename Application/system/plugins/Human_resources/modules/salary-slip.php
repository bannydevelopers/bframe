...
if(isset($_POST['delete_salary_slip'])){
    $db->delete('salary_slip')->where(['user_reference'=>intval($_POST['delete_salary_slip'])])->commit();
...
$salary_slip = $db->select('salary_slip')
              ->order_by('salary_slip_id', 'desc')->fetchAll();
